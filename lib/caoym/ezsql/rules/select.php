...
use caoym\ezsql\impls\ExecImpl;
use caoym\ezsql\impls\SelectImpl;
use caoym\ezsql\impls\FromImpl;
use caoym\ezsql\impls\JoinImpl;
use caoym\ezsql\impls\JoinOnImpl;
use caoym\ezsql\impls\WhereImpl;
use caoym\ezsql\impls\GroupByImpl;
use caoym\ezsql\impls\OrderByImpl;
use caoym\ezsql\impls\LimitImpl;
use caoym\ezsql\impls\ForUpdateOfImpl;
use caoym\ezsql\impls\ForUpdateImpl;
...
class FromRule extends GetRule
{
     ...
     * @param string $table
     * @return \caoym\ezsql\rules\select\JoinRule
     */
...
class ForUpdateOfRule extends GetRule
{
     ...
     * @param string $column
     * @return \caoym\ezsql\rules\select\GetRule
     */
...
class ForUpdateRule extends GetRule
{
     ...
     * @return \caoym\ezsql\rules\select\ForUpdateOfRule
     */
...
class LimitRule extends ForUpdateRule
{
     ...
     * @param int $start
     * @param int $size
     * @return \caoym\ezsql\rules\select\ForUpdateRule 
     */
...
class GroupByRule extends OrderByRule
{
     ...
     * @param string $column
     * @return \caoym\ezsql\rules\select\HavingRule
     */
...
class JoinRule extends WhereRule
{
     ...
     * @param string $table
     * @return \caoym\ezsql\rules\select\JoinOnRule
     */
...
class JoinOnRule extends BasicRule
{
     ...
     * @return \caoym\ezsql\rules\select\WhereRule
     */
