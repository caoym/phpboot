...
class Swagger extends SwaggerObject
{
     ...
     */
    public function appendControllerDoc(Application $app, ControllerContainer $controller)
    {
        //tags
        $tag = new TagObject();
